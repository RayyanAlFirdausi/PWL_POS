...
class UserController extends Controller
{
    ...
    public function create() {
        ...
        $level = LevelModel::all(); // ambil data level untuk ditampikan di form
        $activeMenu = 'user'; // set menu yang sedang aktif
    ...
    public function destroy(string $id) {
        ...
        try{
            ...
            return redirect('/user')->with('eror', 'Data user gagal dihapus masih terdapat tabel lain yang terkait dengan data ini');
        }
    }
}
